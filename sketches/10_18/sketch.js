  ...
  drawMe() {
    ...
    for (let i = 0; i < this.aryPoint.length; i++) {
      ellipse(
        ...
        width / 2 / _tileNumR * this.aryPoint[i][0] * tan(2*PI / _tileNumT * this.aryPoint[i][1]), 10, 10);
        ...
        ellipse(
        width / 2 / _tileNumR * this.aryPoint[i][0] * cos(2*PI / _tileNumT * this.aryPoint[i][1]),
        width / 2 / _tileNumR * this.aryPoint[i][0] * sin(2*PI / _tileNumT * this.aryPoint[i][1]), 30, 30);
    }
    // endShape();
    pop();
  }
