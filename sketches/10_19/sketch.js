  ...
  drawMe() {
    ...
    for (let i = 0; i < this.aryPoint.length; i++) {
      rect(
        ...
        width / 2 / _tileNumR * this.aryPoint[i][0] * tan(2*PI / _tileNumT * this.aryPoint[i][1]), 20, 20);

        rect(
        width / 2 / _tileNumR * this.aryPoint[i][0] * sin(2*PI / _tileNumT * this.aryPoint[i][1]),
        width / 2 / _tileNumR * this.aryPoint[i][0] * tan(2*PI / _tileNumT * this.aryPoint[i][1]), 30, 30);

        rect(
        width / 2 / _tileNumR * this.aryPoint[i][0] * cos(2*PI / _tileNumT * this.aryPoint[i][1]),
        width / 2 / _tileNumR * this.aryPoint[i][0] * sin(2*PI / _tileNumT * this.aryPoint[i][1]), 50, 50);
    }
    // endShape();
    pop();
  }
