...
class f {
  ...
  drawMe() {
    ...
    for (let i = 0; i < this.aryPoint.length; i++) {
        ...
        width / 2 / _tileNumR * this.aryPoint[i][0] * cos(PI / _tileNumT * this.aryPoint[i][1]), 200, 200);


        rect(
        width / 2 / _tileNumR * this.aryPoint[i][0] * tan(2*PI / _tileNumT * this.aryPoint[i][1]),
        width / 2 / _tileNumR * this.aryPoint[i][0] * cos(3*PI / _tileNumT * this.aryPoint[i][1]), 200, 200);

        rect(
        width / 2 / _tileNumR * this.aryPoint[i][0] * cos(PI / _tileNumT * this.aryPoint[i][1]),
