...
function TriangleRecurse(p1, p2, p3, i,maxD) {
  ...
  //
  if (i == 2){//set a new maxdepth after set amount of rounds
    maxD = i+2 + floor(random()*(maxD-i));
  }
  ...
  var sd = 1;
  var t1 = (rG[i][0] * sd % 1) + 10;//this uses my precalculated randoms
  var t2 = (rG[i][1] * sd % .8) + 1;
  var t3 = (rG[i][2] * sd % .6) + 0.2
